...
in
{
  options.myServices.open-archiver = {
    ...
    appImage = mkOption {
      type = types.str;
      default = "logiclabshq/open-archiver:v0.6.0"; # renovate: docker
    };
    ...
    valkeyImage = mkOption {
      type = types.str;
      default = "valkey/valkey:9.1.2-alpine"; # renovate: docker
    };

    meilisearchImage = mkOption {
      type = types.str;
      default = "getmeili/meilisearch:v1.53.2"; # renovate: docker
    };
