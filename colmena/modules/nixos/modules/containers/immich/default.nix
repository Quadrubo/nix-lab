...
in
{
  options.myServices.immich = {
    ...
    serverImage = mkOption {
      type = types.str;
      default = "ghcr.io/immich-app/immich-server:v2.7.5"; # renovate: docker
    };

    machineLearningImage = mkOption {
      type = types.str;
      default = "ghcr.io/immich-app/immich-machine-learning:v2.7.5"; # renovate: docker
    };
    ...
    dbImage = mkOption {
      type = types.str;
      default = "ghcr.io/immich-app/postgres:16-vectorchord0.4.3-pgvectors0.2.0@sha256:1a078b237c1d9b420b0ee59147386b4aa60d3a07a8e6a402fc84a57e41b043a4"; # renovate: docker
    };
