...
in
{
  options.myServices.immich = {
    ...
    serverImage = mkOption {
      type = types.str;
      default = "ghcr.io/immich-app/immich-server:v3.1.0"; # renovate: docker
    };

    machineLearningImage = mkOption {
      type = types.str;
      default = "ghcr.io/immich-app/immich-machine-learning:v3.1.0"; # renovate: docker
    };

    redisImage = mkOption {
      type = types.str;
      default = "docker.io/valkey/valkey:9@sha256:c123e3715db63d06d4ad6964884037aa0d5d4d703939b9929954112889708e1d"; # renovate: docker
    };
