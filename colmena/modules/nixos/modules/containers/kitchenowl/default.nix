...
in
{
  options.myServices.kitchenowl = {
    ...
    webImage = mkOption {
      type = types.str;
      default = "tombursch/kitchenowl-web:v0.7.10"; # renovate: docker
    };

    backendImage = mkOption {
      type = types.str;
      default = "tombursch/kitchenowl-backend:v0.7.10"; # renovate: docker
    };

    dbImage = mkOption {
      type = types.str;
      default = "postgres:18.6"; # renovate: docker
    };
